...
if __name__ == "__main__":
    ...
    graph.generate_square_grid(6, 5)
    ...
    print(bfs_alg.find_path(graph, graph.nodes['node 1'], graph.nodes['node 22'], "forward"))

    dfs_alg = pathfinding_algorithm.BreathFirstSearch()
    print(dfs_alg.find_path(graph, graph.nodes['node 1'], graph.nodes['node 22'], "forward"))
